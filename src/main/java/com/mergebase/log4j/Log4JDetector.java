                ...
                if (isLog4j) {
                    ...
                    if (isVulnerable) {
                        if (isLog4j_2_10_0) {
                            if (isSafe) {
                                if (isLog4j_2_12_2) {
                                    buf.append("== 2.12.2 VULNERABLE");
                                    foundHits = true;
                                } else {
                                    if (isLog4j2_12_3) {
                                        if (hasJdbcJndiDisabled) {
                                            buf.append("== 2.12.4 SAFE");
                                        } else {
                                            buf.append("== 2.12.3 VULNERABLE");
                                            foundHits = true;
                                        }
                                    } else if (isLog4j2_17) {
                                        if (hasJdbcJndiDisabled) {
                                            buf.append(">= 2.17.1 SAFE");
                                        } else {
                                            buf.append("== 2.17.0 VULNERABLE");
                                            foundHits = true;
                                        }
                                    } else if (isLog4j2_16) {
                                        buf.append("== 2.16.0 VULNERABLE");
                                        foundHits = true;
                                    } else {
                                        buf.append("== 2.15.0 VULNERABLE");
                                        foundHits = true;
                                    }
                                }
                            } else {
                                buf.append(">= 2.10.0 VULNERABLE");
                            }
                        } else {
                            if (isLog4j2_3_1) {
                                isSafe = true;
                                if (hasJdbcJndiDisabled) {
                                    buf.append("== 2.3.2 SAFE");
                                } else {
                                    buf.append("== 2.3.1 VULNERABLE");
                                    foundHits = true;
                                }
                            } else {
                                buf.append(">= 2.0-beta9 (< 2.10.0) VULNERABLE");
                            }
                        }
                    } else {
                        buf.append("<= 2.0-beta8 VULNERABLE");
                    }
                    if (!isSafe) {
                        foundHits = true;
                    }
